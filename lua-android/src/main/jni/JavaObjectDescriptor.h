 ...
 */
class JavaObjectDescriptor : public LuaObjectDescriptor
{
public:
     ...
     * @param object Java对象
     */
    JavaObjectDescriptor(LuaContext *context, JNIEnv *env, jobject object);
     ...
     */
    JavaObjectDescriptor(LuaContext *context, JNIEnv *env, jobject object, LuaExportTypeDescriptor *typeDescriptor);

    /**
     * 描述器对象析构方法
     */
    virtual ~JavaObjectDescriptor();
