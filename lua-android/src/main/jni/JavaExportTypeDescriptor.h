 ...
 * Java导出类型
 */
class JavaExportTypeDescriptor : public LuaExportTypeDescriptor
{
public:
     ...
     */
    JavaExportTypeDescriptor (std::string &typeName, JNIEnv *env, jclass jType, LuaExportTypeDescriptor *parentTypeDescriptor);

    /**
     * 释放对象
     */
    virtual ~JavaExportTypeDescriptor();
