 ...
 * Java导出方法
 */
class JavaExportMethodDescriptor : public LuaExportMethodDescriptor
{
public:
     ...
     */
    JavaExportMethodDescriptor(std::string name, std::string methodSignature, LuaJavaMethodType type);
